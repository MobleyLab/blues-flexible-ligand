...
def runNCMC(platform_name, nstepsNC, nprop, outfname):
    ...
    opt = { 'temperature' : 300.0, 'friction' : 1, 'dt' : 0.002,
            'nIter' : 10000, 'nstepsNC' : nstepsNC, 'nstepsMD' : 1000, 'nprop' : nprop,
    ...
    netcdf_reporter = NetCDFReporter('r3i.nc', 500, crds=True)
    ...
    state = simulations.md.context.getState(getPositions=True, getVelocities=True, enforcePeriodicBox=True)
